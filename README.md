1. Automated tests in the recipe project development pipeline should be within GitHub Actions because tests run every time code is pushed, so that the developer knows the results of the code right away.
